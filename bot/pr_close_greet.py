...
async def issue_opened_event(event, gh, *args, **kwargs):
    ...
    message_c = f"<br><table><tbody><tr><td>Thanks for closing this PR and contributing to the repo @{author} ! We hope you loved to work with our repository if you have star this repo and show some love 💗.</td></tr></tbody></table>"
    
    #message to be posted
    message_m = f"<br><table><tbody><tr><td>Congratulations 🎉 ! Your Pull request has been merged 🥳 ! Thanks for contributing to our repository @{author} ! We hope you loved working on our repository ! Happy hacking 😀.</td></tr></tbody></table>"

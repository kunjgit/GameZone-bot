...
async def issue__comment_create_event(event, gh, *args, **kwargs):
    ...
    #assignee check
    assignee = event.data['issue']['assignee']
    ...
    message = "We cannot assign this issue to you as it already assigned to someone ! Thank you so much for showing your interest";
    message1 = "We cannot assign this issue to you as you are not owner of this issue ! Thank you ";
